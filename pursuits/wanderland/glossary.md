...
supersedes: []
superseded-by:
tags: [wanderland, glossary, context, vocabulary, screenery]
---

# Wanderland glossary

Controlled vocabulary for Wanderland / Screenery — the shared language across the business, the product, and the tooling. (Pattern adopted from `/grill-with-docs`.) One term = one definition; flag collisions before recording. Definitions are `confirmed` only after Saar states them; everything else is `to-confirm`.
...
- [[pursuits/wanderland/screenery/index]]
- [[projects/wanderland/README]]
