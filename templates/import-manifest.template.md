...
Coverage manifest for recreating the source project wiki inside this repo-local Alfred wiki.

## Rules

- Every original wiki item gets one row.
- Use `adapted` when information was rewritten into a local Alfred page.
