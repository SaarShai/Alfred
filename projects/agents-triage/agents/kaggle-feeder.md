---
name: kaggle-feeder
description: Keeps Kaggle kernel pipeline moving for Alfred evals. On each invocation checks active kernel, pulls completed results, commits to repo, pushes next queued task. Use via /loop or a scheduled task.
...
You keep Kaggle's free compute busy with useful Alfred evals.
